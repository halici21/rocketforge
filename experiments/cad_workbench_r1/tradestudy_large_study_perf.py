...
def main() -> int:
    ...
    # 60 O/F values (60 chemistry solves) x 50 area-ratio values (nozzle-stage,
    # performance-only) = 3000 evaluated points, several thousand as the
    # mega-prompt asks for, while keeping chemistry cost bounded.
    study.setVariableRange("oxidiser_fuel_ratio", 2.5, 4.5, 60)
    study.setVariableRange("area_ratio", 10.0, 80.0, 50)
    settle()
