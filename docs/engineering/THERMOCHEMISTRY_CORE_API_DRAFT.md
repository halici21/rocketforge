> **Superseded.** This draft was promoted to [THERMOCHEMISTRY_API_V1.md](THERMOCHEMISTRY_API_V1.md) by Phase 5G and frozen as THERMOCHEMISTRY API v1.0. It is kept for history; the v1 document is normative.

# Thermochemistry Core API — DRAFT / PROVISIONAL
