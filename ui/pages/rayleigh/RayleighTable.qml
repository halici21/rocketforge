    ...
    ColumnLayout {
        ...
        RFPanel {
            ...
            RowLayout {
                ...
                Text {
                    Layout.fillWidth: true
                    readonly property string plainText: "Generated by RocketForge — T/T* peaks at M = "
        ...
        RowLayout {
            ...
            RFPanel {
                ...
                Text {
                    Layout.fillWidth: true
                    readonly property string plainText: Rayleigh.tableFooter
                    text: Notation.rich(plainText)
                    textFormat: Notation.textFormat(plainText)
                    wrapMode: Text.WordWrap
                    color: Theme.textMuted
            ...
            RFPanel {
                ...
                Text {
                    Layout.fillWidth: true
                    readonly property string plainText: Rayleigh.referenceMessage
                    text: Notation.rich(plainText)
                    textFormat: Notation.textFormat(plainText)
                    wrapMode: Text.WordWrap
